...
const en: Messages = {
  "remediation.title":"Remediation Assistant","remediation.description":"A plain-language tip for each finding from the latest audit.",
  ...
  "remediation.saved":"Remediation pack saved locally.","remediation.noPack":"No findings yet. Run a governance audit first.",
...
const overlays: Partial<Record<Locale, Messages>> = {
  "zh-CN":{"remediation.title":"整改助手","remediation.description":"针对最近一次审计的每条发现，给出一句话整改建议。","remediation.safety":"LANPilot 不执行修复、不登录服务，也不修改配置。","remediation.generate":"生成整改包","remediation.export":"导出整改包","remediation.retest":"进入授权复测","remediation.saved":"整改包已保存到本地。","remediation.noPack":"暂无发现，请先运行治理审计。","remediation.manualSteps":"人工整改步骤","remediation.validationSteps":"验证步骤","remediation.rollback":"回退注意事项","remediation.status.open":"待处理","remediation.status.assigned":"已分派","remediation.status.in_progress":"处理中","remediation.status.remediated":"已整改","remediation.status.accepted_risk":"已接受风险","remediation.status.retest_required":"需要复测","remediation.status.verified":"已验证"},
  "zh-TW":{"remediation.title":"修正助手","remediation.description":"針對最近一次稽核的每條發現，給出一句話修正建議。","remediation.safety":"LANPilot 不執行修復、不登入服務，也不修改設定。","remediation.generate":"產生修正包","remediation.export":"匯出修正包","remediation.retest":"進入授權複測","remediation.saved":"修正包已儲存於本機。","remediation.noPack":"暫無發現，請先執行治理稽核。","remediation.manualSteps":"人工修正步驟","remediation.validationSteps":"驗證步驟","remediation.rollback":"回復注意事項","remediation.status.open":"待處理","remediation.status.assigned":"已分派","remediation.status.in_progress":"處理中","remediation.status.remediated":"已修正","remediation.status.accepted_risk":"已接受風險","remediation.status.retest_required":"需要複測","remediation.status.verified":"已驗證"},

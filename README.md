...
Download the Developer ID signed and Apple notarized DMG from [LANPilot Audit v1.7.0](https://github.com/cqforest123-wq/lanpilot-audit/releases/tag/v1.7.0):

- [LANPilot-Audit_1.7.0_aarch64.dmg](https://github.com/cqforest123-wq/lanpilot-audit/releases/download/v1.7.0/LANPilot-Audit_1.7.0_aarch64.dmg)
- [SHA256SUMS.txt](https://github.com/cqforest123-wq/lanpilot-audit/releases/download/v1.7.0/SHA256SUMS.txt)
...
The v1.7.0 DMG is Developer ID signed, Apple notarized, stapled, and Gatekeeper accepted.
